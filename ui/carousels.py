...
def show_fact_carousel():
    ...
    # Create HTML/JavaScript carousel with liquid glass styling
    html_code = f"""
    <div style="padding: 0.25rem; background: linear-gradient(135deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.05) 100%); border-radius: 0.75rem; margin: 0; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.18); height: 100%; box-sizing: border-box; padding-inline: 1rem;">
        <div style="display: flex; align-items: center; justify-content: center; gap: 15px; height: 100%;">
            <button onclick="prevFact()" style="padding: 10px 18px; cursor: pointer; background: rgba(255, 255, 255, 0.15); color: white; border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 8px; font-size: 16px; transition: all 0.3s ease; backdrop-filter: blur(4px); box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">←</button>
            <div style="flex: 1; text-align: center;">
                <div style="color: rgba(255, 255, 255, 0.9); font-weight: 600; margin-bottom: 6px; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2);">FACTS</div>
                <div id="fact-display" style="color: rgba(255, 255, 255, 0.95); font-size: 14px; line-height: 1.5; min-height: 35px; display: flex; align-items: center; justify-content: center; text-shadow: 0 1px 2px rgba(0, 0, 0, 0.1);">{facts[0]}</div>
            ...
            <button onclick="nextFact()" style="padding: 10px 18px; cursor: pointer; background: rgba(255, 255, 255, 0.15); color: white; border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 8px; font-size: 16px; transition: all 0.3s ease; backdrop-filter: blur(4px); box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">→</button>
        </div>
    </div>
    <style>
        html {{
